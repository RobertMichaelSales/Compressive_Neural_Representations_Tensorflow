...
class FileStructureClass():
    ...
    def __init__(self,base_directory,network_name):
        
        #======================================================================    
        # Get base directory and network save name
        ...
        self.tensorboard_path = os.path.join(self.base_directory,
                                             "training",
                                             "logs",
                                             "tensorboard",
                                             network_name)  
        ...
        self.csv_summary_path = os.path.join(self.base_directory,
                                             "training",
                                             "logs",
                                             "csv_summary",
                                             network_name)
        ...
        self.checkpoints_path = os.path.join(self.base_directory,
                                             "training",
                                             "checkpoints",
                                             network_name)
        ...
        self.trained_model_path = os.path.join(self.base_directory,
                                               "training",
                                               "trained_models",
                                               network_name)
        ...
        self.output_volume_path = os.path.join(self.base_directory,
                                               "outputs",
                                               "volumes",
                                               network_name)
