...
def PlotMSEandTimevsBatchSize(save=False):
    ...
    # Set input filepath
    input_volume_filepath = "/home/rms221/Documents/Compressive_Neural_Representations_Tensorflow/NeurComp_AuxFiles/inputs/volumes/passage.npy"
    ...
    for experiment_directory in experiment_directories:
        ...
        batch_size_base2 = [math.log2(x) for x in batch_size]
                
    #======================================================================
    # Matplotlib code
        
    ax1.scatter(batch_size,mean_squared_loss_percentage,marker="s",color=colours["blue"])
    ax1.plot(batch_size,mean_squared_loss_percentage,linestyle="dotted",color=colours["blue"])
    
    ax2.scatter(batch_size,training_duration,marker="s",color=colours["red"])
    ax2.plot(batch_size,training_duration,linestyle="dotted",color=colours["red"])
...
def PlotMSEvsNormalisedBatchSize(save=False):
    ...
    for experiment_directory in experiment_directories:
        ...
        batch_size_normalised = [(x/size) for x in batch_size]
                
    #======================================================================
    # Matplotlib code
        
    ax1.scatter(batch_size_normalised,mean_squared_loss_percentage,marker="s",color=colours["blue"])
    ax1.plot(batch_size_normalised,mean_squared_loss_percentage,linestyle="dotted",color=colours["blue"])
    ...
    # Set x- and y-labels
    ax1.set_xlabel(r"Batch Size / Input Field Size")
    ax1.set_ylabel(r"Mean-Squared Error / %",color=colours["blue"])
