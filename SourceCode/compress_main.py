...
def compress(network_config,dataset_config,runtime_config,training_config,o_filepath):
    ...
    if runtime_config.save_network_flag:
        ...
        network_data_filepath = os.path.join(o_filepath,"network_data_iso.json")
        SaveNetworkJSON(network=ISONet,network_data_filepath=network_data_filepath)
        print("{:30}{}".format("Saved network data to:",network_data_filepath.split("/")[-1]))
